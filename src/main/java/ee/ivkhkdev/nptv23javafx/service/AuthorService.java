...
@Service
public class AuthorService implements ee.ivkhkdev.nptv23javafx.interfaces.AuthorService {
    private SessionManager sessionManager;
    private AuthorRepository authorRepository;

    public AuthorService(SessionManager sessionManager, AuthorRepository authorRepository) {
